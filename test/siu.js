...
describe('SIU', () => {
  ...
  it(`S12 - Notification of new appointment booking`, (done) => {
  ...
  it(`S13 - Notification of appointment rescheduling`, (done) => {
  ...
  it(`S14 - Notification of appointment modification`, (done) => {
  ...
  it(`S15 - Notification of appointment cancellation`, (done) => {
  ...
  it(`S17 - Notification of appointment deletion`, (done) => {
  ...
  it(`S26 - Notification that patient did not show up for scheduled appointment`, (done) => {
