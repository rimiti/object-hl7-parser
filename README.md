...
const message_to_encode = {
  ...
  "fiche": {
    ...
    "contacts": [{
      "number": "0100000000",
      "email": "dobairro.dimitri@gmail.com"
    }, {
      "number": "0200000000"
    }]
  },
...
PID|||123456^^^ODS^^PI||DO BAIRRO^Dimitri^^^^^L||19920506|M|Nom usuel||Avenue des Champs-Élysées^^Paris^^75000^^^^^||0100000000^^^dobairro.dimitri@gmail.com^^^^~0200000000^^^^^^^|
RGS|1
